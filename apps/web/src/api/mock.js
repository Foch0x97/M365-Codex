...
const REQUEST_STATUS_CYCLE = ['completed', 'completed', 'failed', 'in_progress'];
...
let settings = {
    network: {
        public_api_base_url: { value: 'http://192.168.0.5:8080/v1', source: 'db', editable: true, requires_restart: false },
        public_admin_url: { value: 'http://192.168.0.5:8080/admin', source: 'db', editable: true, requires_restart: false },
        trust_proxy: { value: false, source: 'default', editable: true, requires_restart: true },
        port: { value: 8080, source: 'env', editable: false, requires_restart: true },
        data_dir: { value: '/data', source: 'env', editable: false, requires_restart: true },
    },
    scheduler: {
        sticky_account: { value: true, source: 'default', editable: true, requires_restart: false },
        retry_limit: { value: 3, source: 'default', editable: true, requires_restart: false },
        cooldown_seconds: { value: 60, source: 'default', editable: true, requires_restart: false },
    },
    logging: {
    ...
    oauth: {
        ...
        redirect_uri: { value: 'https://login.microsoftonline.com/common/oauth2/nativeclient', source: 'default', editable: false, requires_restart: true },
        ...
        scopes: { value: 'sydney/M365Chat.Read sydney/sydney.readwrite offline_access openid profile', source: 'default', editable: true, requires_restart: true },
    },
    tools: {
        tools_mode: { value: 'auto', source: 'default', editable: true, requires_restart: false },
        max_calls_per_round: { value: 4, source: 'default', editable: true, requires_restart: false },
        max_rounds: { value: 8, source: 'default', editable: true, requires_restart: false },
        max_calls_total: { value: 32, source: 'default', editable: true, requires_restart: false },
        max_result_bytes: { value: 65_536, source: 'default', editable: true, requires_restart: false },
        max_repair_attempts: { value: 2, source: 'default', editable: false, requires_restart: false },
    },
    files: {
        max_file_bytes: { value: 20_971_520, source: 'default', editable: true, requires_restart: false },
        max_request_bytes: { value: 52_428_800, source: 'default', editable: true, requires_restart: false },
        retention_hours: { value: 72, source: 'default', editable: true, requires_restart: false },
    },
};
const auditLogs = [
...
export const mockAdminApi = {
    ...
    getCodexConfig: (apiKeyEnv) => delay({
